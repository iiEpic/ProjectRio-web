# Generated by Django 5.0.7 on 2024-07-31 05:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('community_type', models.CharField(help_text='Official, Unofficial', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(help_text='Season, League, or Tournament', max_length=120)),
        ...
        migrations.AddField(
            model_name='riouser',
            name='rio_key',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.token'),
        ),
        migrations.AddField(
            model_name='apikey',
            name='token',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api.token'),
        ),
        migrations.AddField(
            model_name='riouser',
            name='user_group',
            field=models.ManyToManyField(blank=True, to='api.usergroup'),
        ),
    ]
