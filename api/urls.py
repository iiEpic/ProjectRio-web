...
urlpatterns = [
    ...
    re_path(r"^v2/characters/$", views.GenericView.as_view(), name='characters'),
    ...
    re_path(r"^v2/tag/$", views.GenericView.as_view(), name='tag'),
    re_path(r"^v2/tagset/$", views.GenericView.as_view(), name='tagset'),
